...
public class DriveAroundObstacleWithPID extends AutoCommand {
    ...
    public DriveAroundObstacleWithPID(double distanceToBox, double boxSize, double finalStraightDistance) {
        ...
        addCommands(
            ...
            new DriveWithPID(distanceToBox, 0.1, 0, 1).withTimeout(3),
            ...
            new DriveWithPID(detourDistance, 0.1, 0, 1).withTimeout(3),
            ...
            new DriveWithPID(finalStraightDistance, 0.1, 0, 1).withTimeout(4)
        );
    }
}